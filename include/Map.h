...
class Map {
 ...
 public:
  ...
  // This avoid that two points are created simultaneously in separate threads (id
  // conflict)
 ...
 protected:
  ...
  // Save/load, the set structure is broken in libboost 1.58 for ubuntu 16.04, a vector
  // is serializated
