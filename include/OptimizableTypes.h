...
class EdgeSE3ProjectXYZToBody : public g2o::BaseBinaryEdge<2,
                                                           Eigen::Vector2d,
                                                           g2o::VertexSBAPointXYZ,
                                                           g2o::VertexSE3Expmap> {
 public:
...
class EdgeSim3ProjectXYZ : public g2o::BaseBinaryEdge<2,
                                                      Eigen::Vector2d,
                                                      g2o::VertexSBAPointXYZ,
...
class EdgeInverseSim3ProjectXYZ
 ...
 public:
  ...
  void computeError() {
    ...
    Eigen::Vector2d obs(_measurement);
    _error =
        obs - v1->pCamera2->project((v1->estimate().inverse().map(v2->estimate())));
  }
