...
class Viewer {
 public:
  ...
  // Main thread function. Draw points, keyframes, the current camera pose and the last
  // processed frame. Drawing is refreshed according to the camera fps. We use Pangolin.
  void Run();
