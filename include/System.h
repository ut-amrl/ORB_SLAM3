...
class System {
 ...
 public:
  ...
  // Initialize the SLAM system. It launches the Local Mapping, Loop Closing and Viewer
  // threads.
 ...
 private:
  ...
  // Loop Closer. It searches loops with every new keyframe. If there is a loop it
  // performs a pose graph optimization and full bundle adjustment (in a new thread)
  // afterwards.
